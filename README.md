...
Download the SYMB-FER Template
...
python SYMB-FER_3_0/symbfer_engine.py path/to/token.txt
...
Your SYMB-FER token contains your personal context: active projects, relationships, operational details, and current state. This is what makes it work. Keep your personal token private. Do not publish it to a public repository.
...
SYMB-FER_PROTOCOL.md
	Retrieval protocol and tool call instructions
symb_fer_generator.py
	Python CLI token generator
SYMB-FER_STATE_TEMPLATE.json
	Starter state file with documented fields
SYMB-FER_STATE_EXAMPLE.json
	Example state file
SYMB-FER_v2_COMPRESSED_EXAMPLE.txt
	Full v2.0 compressed token example
SYMB-FER_3_0/	Validation engine, tests, and current continuity hardening work
Design Intent
